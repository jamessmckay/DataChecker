...
export class RuleExecutionComponentComponent implements OnInit {
  ...
  getRuleResults() {
    ...
    this.apiService.rule
      .getRuleDetail(this.rule.id, this.selectedDatabaseEnvironment.id)
      .subscribe(
        (result) => {
  ...
  loadPopover(result: { executedSql: any }) {
  ...
  viewRuleExecutionLogDetails(ruleLogDetailsContent: any, ruleResult: any) {
    this.ruleDetailsLogResult = null;
    const idExecutionLog = ruleResult.id;
    this.apiService.ruleExecutionLogDetail
      ...
      .subscribe((result) => {
        if (result != null) {
          ...
          this.toastr.info(
            'No execution log details for rule ' + ruleResult.name,
            'Information'
          );
        }
      });
  ...
  executeSqlDiagnostic(
    ruleExecutionDiagnosticLogDetailsContent: any,
    result: any
  ) {
    this.ruleDetailsLogResult = null;
    const idExecutionLog = result.id;
    this.apiService.ruleExecutionLogDetail
      .executeDiagnosticSqlFromLogIdAsync(idExecutionLog)
