...
export class RuleService {
  ...
  public getRuleDetail(
    ...
    return this.http
      .get(this.url + '/Results/' + id + '/' + databaseEnvironmentId, {
  ...
  public addRule(rule: any): Observable<any> {
    ...
    return this.http.post(this.url, rule).pipe(map((result: any) => result));
  }
  ...
  public executeDiagnostic(
    idDiagnostic: string,
    databaseEnvironmentId: string
  ): Observable<any> {
    return this.http
      .post(
        this.url + '/RunDiagnosticAndReturnTable',
        {
          ruleExecutionLogId: idDiagnostic,
  ...
  public executeRuleTest(
    ...
    return this.http
      .post(
        this.url + '/TestRun',
        { databaseEnvironmentId, ruleToTest: rule },
        { responseType: 'json' }
      )
      .pipe(map((result: any) => result));
  }
  ...
  public moveRuleToContainer(rules: any, container: any): Observable<any> {
    return this.http
      .post(this.url + '/MoveRulesToContainer', {
        rules,
