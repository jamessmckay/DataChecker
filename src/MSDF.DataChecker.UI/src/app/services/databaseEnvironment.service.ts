...
export class DatabaseEnvironmentService {
  ...
  public updateDatabaseEnvironment(
    databaseEnvironment: DatabaseEnvironment
  ): Observable<any> {
    return this.http
  ...
  public deleteDatabaseEnvironment(
    databaseEnvironment: DatabaseEnvironment
  ): Observable<any> {
    return this.http
  ...
  public duplicateDatabaseEnvironment(
    databaseEnvironment: DatabaseEnvironment
  ): Observable<any> {
    return this.http
  ...
  public testDatabaseEnvironmentById(
    databaseEnvironment: DatabaseEnvironment
  ): Observable<any> {
    return this.http
