...
alter table datachecker.containers drop constraint if exists fk_containerscatalogsruledetailsdestinationid;
...
alter table datachecker.containers drop constraint if exists fk_containerscontainersparentcontainerid;
...
alter table datachecker.containers drop constraint if exists fk_containerscontainertypescontainertypeid;
...
alter table datachecker.rules drop constraint if exists fk_rulescontainerscontainerid;
alter table datachecker.rules add constraint fk_rulescontainerscontainerid foreign key (containerid)
references datachecker.containers (id)
on delete cascade;

alter table datachecker.tagentities drop constraint if exists fk_tagentitiescontainerscontainerid;
alter table datachecker.tagentities add constraint fk_tagentitiescontainerscontainerid foreign key (containerid)
references datachecker.containers (id);

alter table datachecker.tagentities drop constraint if exists fk_tagentitiesrulesruleid;
...
alter table datachecker.tagentities drop constraint if exists fk_tagentitiestagstagid;
...
alter table datachecker.userparams drop constraint if exists fk_userparamsdatabaseenvironmentsdatabaseenvironmentid;
...
alter table destination.edfiruleexecutionlogdetails drop constraint if exists fk_edfiruleexecutionlogdetailsruleexecutionlogid;
...
alter table destination.ruleexecutionlogs drop constraint if exists fk_ruleexecutionlogsRulesruleid;
