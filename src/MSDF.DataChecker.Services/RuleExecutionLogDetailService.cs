        ...
        public async Task<RuleExecutionLogDetailBO> GetByRuleExecutionLogIdAsync(int id)
        {
            ...
            if (ruleExecutionLog != null && ruleExecutionLog.RuleDetailsDestinationId != null)
            {
                ...
                if (catalog != null)
                {
                    ...
                    {
                        columnsFromLog = JsonSerializer.Deserialize<Dictionary<string, string>>(ruleExecutionLog.DetailsSchema);
                    }
                    ...
                    if (reader != null)
                    {
                        ...
                        foreach (DataRow row in reader.Rows)
                        {
                            ...
                            {
                                Dictionary<string, string> jsonValues = JsonSerializer.Deserialize<Dictionary<string, string>>(otherDetails);
